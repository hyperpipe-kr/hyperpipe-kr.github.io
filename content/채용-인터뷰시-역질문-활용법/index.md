...
update: "2026-02-12T12:56:00.000Z"
date: "2025-10-06"
상태: "Ready"
...
[object Promise]```plain text
스토리 분석 > 설계 문서 작성 > 설계 문서 리뷰 > 구현 > 코드 리뷰 > QA > 배포
```

[object Promise]## **조직과 팀의 목표는 무엇인지?**
...
[object Promise]## 입사하게 된다면 어떻게 그 목표에 기여하게 되는지?
...
[object Promise]## 어떤 방식으로 일하고 있는지?
...
[object Promise]당연하지만 채용 공고에 나와 있는 내용은 질문하지 않도록 해. 자칫 공고를 제대로 확인하지 않고 지원한 것으로 오해 받을 수 있기 때문이야.
